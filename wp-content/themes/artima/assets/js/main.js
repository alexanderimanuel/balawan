...
(function ($) {
    ...
    /*-----------------------------------------------------------------------------------
        Template Name: Artima – Modern Architecture & Interior Wordpress Theme
        Author: RRDevs
    ...
    $('.sidebar__widget select').niceSelect();
    /*======================================
    One Page Scroll Js
    ========================================*/
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/rr_slider_main.default', rrslidermain);
    });

    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/rr_skill.default', rrskill);
    });
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/about.default', rrabout);
    });

    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/rr_filter.default', rrfilter);
    });
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/instagram_bar.default', instagrambar);
    });
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/rr_projects_slider.default', rrprojectsslider);
    });
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/rr_service.default', rrservice);
    });
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/blog_post.default', blogPost);
    });
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/rr_testimonial.default', rrtestimonial);
    });
    ...
    /* our-featured-service***/
    let gallery_thumbs_active = new Swiper(".gallery-thumbs-active", {
        slidesPerView: 1,
        spaceBetween: 0,
        loop: true,
        clickable: true,
    ...
    gallery_thumbs_active.controller.control = slider;
